...
생활 속에서 알고리즘을 적용하여 생각하는 여러 사례를 소개하는 책입니다. 알고리즘 입문자 및 초급자에게 굉장히 좋은 책이라는 생각이 듭니다. 일상 다양한 사례들을 통해 컴퓨팅적 사고를 어떻게 적용해 볼 수 있을지 생각할 수 있을 것 같습니다. 책을 읽고 각 장의 중요 키워드를 정리해 보았습니다. 각 키워드의 내용을 잘 알지 못하거나 생활 속에서 어떻게 적용하여 문제를 풀어나가는지 궁금하신 분들께 추천해 드립니다. 
